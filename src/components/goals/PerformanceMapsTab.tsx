...
type PerformanceMapStatus = "draft" | "development" | "active";
...
const STATUS_LABELS: Record<PerformanceMapStatus, string> = {
  draft: "ЧЕРНОВИК",
  development: "РАЗРАБОТКА",
  active: "АКТИВНАЯ",
};

const STATUS_STYLES: Record<PerformanceMapStatus, string> = {
...
const UNIQUE_FILTER_OPTIONS = {
  statuses: (["draft", "development", "active"] as PerformanceMapStatus[]).map(
            ...
            <TableHeader>
              <TableRow className="bg-muted/40 hover:bg-muted/40 border-b">
                ...
                <ColumnFilterHead
                  ...
                  formatOption={(v) =>
                    STATUS_LABELS[v as PerformanceMapStatus] ?? v
                  }
                />
                <ColumnFilterHead
                  className="w-[150px]"
